...
public class PrivacyPolicyFrag extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String privacyPolicy =
                "        <p style=\"text-align:left; margin:4%;\">Your privacy and legal rights are important to us. It is Weather&#39;s policy to respect your privacy regarding any information we may collect from you.<br />\n" +
                "        <br />\n" +
                ...
                "        <br />\n" +
                "        Our app may link to external sites that are not operated by us. Please be aware that we have no control over the content and practices of these sites, and cannot accept responsibility or liability for their respective privacy policies.<br />\n" +
                "        <br />\n" +
                ...
                "        To make use of the Weather app please note that we require and store the following information:<br />\n" +
                "        1. Your current location.<br />\n" +
                "        <br />\n" +
                "        This policy is effective as of 19 January 2021.<br />\n" +
                "        <br />\n" +
